...
<body>
	<div align="center">
		...
		<form:form commandName="personnelcommand" name="addPS" method="post">
			<table border="1" width="350">
				...
				<tr>
					<th>퇴사일:</th>
					<td><input type="text" name="RetireDate" id="RetireDate"></td>
				</tr>
				<tr>
					<th>퇴사사유:</th>
				...
				<tr>
					<th>직급/직책:</th>
					<td><select name="Position_Name" id="Position_Name">
							<option>직급선택</option>
			...
			<div>
				<p align="right">
					<button class="CheckButton" type="submit" onclick="return Check();">전송</button>
				</p>
			</div>
		</form:form>
	</div>
