...
<body>
	<form method="post" action="update.puzzle" name="userinput" onSubmit="return checkIt()">
	<h3 align="center">글수정</h3>
		...
		<div align="center">
			...
			<input type="button" value="취소" onclick="location.href='boardList.puzzle?DEPT_NUM=${board.DEPT_NUM}'">
		</div>
	</form>
</body>
</html>